...
export type WebhookEvent =
  | { event: "grant.completed"; transactionId: string; at: number; data: CheckoutCompletedPayload }
  | { event: "grant.failed"; transactionId: string; at: number; data: CheckoutFailedPayload };
