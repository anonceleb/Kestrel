...
// Source: packages/registry/src/signing.ts (sha256 5dad8c84c6a557eec00bbe14959946286c8a8e3697ac90fe8c39b8ada2491348)
 ...
 */
export function authorizationHeader(e                )         {
  return (
...
export const registerOp = (participant             )                 => ({ op: "register", participant });
export const suspendOp = (subscriberId        )                 => ({ op: "suspend", subscriberId });
export const eraseOp = (subjectRef        )                 => ({ op: "erase", subjectRef });
...
export function assertAuthorizesOperation(auth           , expected                )       {
...
export class Registry {
  ...
  #requireFacilitator(auth           , expected                , now = Math.floor(Date.now() / 1000))              {
