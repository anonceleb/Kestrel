...
// Source: packages/labels/src/cbor.ts (sha256 008185972a1d61d7e43bbb08d77b5f18a85ffce4879139e6566daf06408deaca)
...
export function encodeCBOR(value         )         {
  ...
  if (value instanceof Map) {
    const parts           = [encodeHead(MT_MAP, value.size)];
...
function readArg(buf        , offset        , ai        )                   {
