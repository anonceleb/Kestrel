...
// Source: packages/metering/src/meter.ts (sha256 e85a84ed4020eb6ca4f9bf6d5e32327db37bf27f07569320e8af63331a13ac4c)
...
export class UsageMeter {
   ...
   */
  consume(subscriberId        , now = Date.now())       {
  ...
  remaining(subscriberId        , now = Date.now())         {
    const w = this.#windows.get(subscriberId);
